...
fields = [
 {"key": "content", "label": "簡報內容", "labelEn": "Deck content", "kind": "longText", "defaultValue": SAMPLE,
  "hint": "一頁一段，用一行 --- 分頁。頁首 [cover] [light] [statement] [cols] [dense] [pace=分鐘]；# 標題（**粗**變強調色）；## 小標；- 條列（_底線_變灰字）；| 表格 |；``` 程式碼；> 講稿備註；@embed 網址 嵌右側（加 full 全寬、lazy 按了才載）；@img 網址。完整規格：github.com/yazelin/larch-slide-deck"},
